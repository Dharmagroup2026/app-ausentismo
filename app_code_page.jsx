...
import { 
  Users, Building2, AlertTriangle, FileText, Upload, 
  Filter, CheckCircle, Clock, Search 
} from 'lucide-react';
...
export default function AusentismoDashboard() {
  ...
  // Filtros de empresas y supervisores
    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 p-6 font-sans">
      ...
      {registros.length === 0 ? (
        <div className="flex flex-col items-center justify-center my-20 text-center p-8 bg-slate-800/50 rounded-2xl border border-slate-800">
          ...
          <p className="text-slate-400 max-w-md text-sm mt-1">Sube tu planilla de ausencias para generar los tableros, rankings y métricas automáticamente.</p>
        </div>
      ) : (
        <>
          {/* Filtros */}
